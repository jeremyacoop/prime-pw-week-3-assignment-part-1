...
let favoriteFoods = ['pizza', 'cookies', 'tacos'];
...
console.log('There are ', favoriteFoods.length, ' favorite foods.');
...
console.log('The second animal on the list is ', animalArray[1]);
...
console.log('The last animal on the list is ', animalArray[animalArray.length-1]);
...
favoriteFoods.push('cheesesteak');
console.log('Favorite foods: ', favoriteFoods);
